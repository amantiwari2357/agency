    ...
    <footer className="w-full bg-gray-100 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="md:hidden space-y-6">
          ...
          {/* Services Section */}
          <div>
            <h3 className="text-gray-900 font-semibold mb-3 text-sm uppercase tracking-wider">Services</h3>
          ...
          {/* Company Section */}
          <div>
            <h3 className="text-gray-900 font-semibold mb-3 text-sm uppercase tracking-wider">Company</h3>
            <ul className="space-y-2">
              <li>
          ...
          {/* Contact Section */}
          <div>
            <h3 className="text-gray-900 font-semibold mb-3 text-sm uppercase tracking-wider">Contact</h3>
