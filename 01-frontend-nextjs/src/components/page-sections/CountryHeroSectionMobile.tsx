...
export default function CountryHeroSectionMobile({ countryCode }: CountryHeroSectionProps) {
  return (
    <section className="relative text-center py-16 px-6 bg-gradient-to-br from-blue-50 via-white to-indigo-50 rounded-3xl border border-gray-200 overflow-hidden">
      ...
      <div className="relative">
        ...
        <motion.h1
          className="text-4xl sm:text-5xl font-black tracking-tight max-w-4xl mx-auto leading-tight text-gray-900"
