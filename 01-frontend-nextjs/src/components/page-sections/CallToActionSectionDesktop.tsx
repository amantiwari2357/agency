...
export default function CallToActionSectionDesktop() {
  return (
    <section className="py-20 px-8 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 relative overflow-hidden">
