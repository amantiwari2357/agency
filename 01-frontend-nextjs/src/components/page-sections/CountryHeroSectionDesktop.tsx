...
export default function CountryHeroSectionDesktop({ countryCode }: CountryHeroSectionProps) {
  return (
    <section className="relative text-center py-20 px-6 bg-gradient-to-br from-blue-50 via-white to-indigo-50 rounded-3xl border border-gray-200 overflow-hidden">
      ...
      <div className="relative">
        ...
        <motion.h1
          className="text-6xl font-black tracking-tight max-w-4xl mx-auto leading-tight text-gray-900"
        ...
        <motion.p
          className="text-lg max-w-2xl mx-auto mt-4 text-gray-600 leading-relaxed"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
