...
export default function CountryHeroSectionDesktop({ countryCode }: CountryHeroSectionProps) {
  return (
    <section className="relative text-center py-24 px-6 bg-white rounded-3xl border border-[#4d7cf5]/30 shadow-xl shadow-[#4d7cf5]/10 overflow-hidden">
      ...
      <div className="relative">
        ...
        <motion.h1
          className="text-6xl font-black tracking-tight max-w-4xl mx-auto leading-tight text-[#1c1f26]"
        ...
        <motion.p
          className="text-lg max-w-2xl mx-auto mt-6 text-[#4a5060] leading-relaxed"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
