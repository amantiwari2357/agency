...
export default function ServiceHeroSectionMobile({
  iconName,
  badge,
  title,
  description,
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-6 rounded-3xl border border-gray-200">
