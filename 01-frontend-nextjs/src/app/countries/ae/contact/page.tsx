...
export default function AEContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: MapPin,
      title: "Office",
      value: "Dubai Silicon Oasis, DSO, Dubai, UAE",
      link: null
    },
    {
      icon: Clock,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          >
            ...
            <div className="bg-gradient-to-r from-[#4d7cf5] via-[#4366d8] to-[#3660e0] rounded-2xl p-6 text-white">
              ...
              <a href="tel:+97141234567" className="inline-block px-6 py-3 bg-white text-[#4d7cf5] rounded-xl font-semibold hover:bg-white/90 transition-colors">
                Call Now
              </a>
            </div>
          </motion.div>
