...
export default function INBlogPostPage({ params }: { params: { id: string } }) {
      ...
      <>
        ...
        <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <Link href={`/${countryCode}/blog`} className="text-[#4d7cf5] hover:underline">
              Back to Blog
            </Link>
          </div>
        </main>
            ...
            <div className="border-t border-[#4d7cf5]/30 pt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {relatedPosts.map((relatedPost) => (
                  <Link key={relatedPost.id} href={`/${countryCode}/blog/${relatedPost.id}`}>
