...
export default function INPrivacyPage() {
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none text-[#4a5060] space-y-6">
          ...
          <section>
            ...
            <p>Under Indian data protection laws and other applicable regulations, you have the right to access, correct, or delete your personal data. You may also object to or restrict processing of your data.</p>
          </section>
