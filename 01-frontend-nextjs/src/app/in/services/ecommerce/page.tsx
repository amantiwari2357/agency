...
export const metadata: Metadata = {
  title: "E-Commerce Solutions | AEX Agency India",
  description: "Fashion Retail Platforms & Inventory Management across India. Pricing in INR.",
  alternates: {
    canonical: "https://aexagency.com/in/services/ecommerce",
  },
  openGraph: {
    title: "E-Commerce Solutions | AEX Agency India",
    description: "Fashion Retail Platforms & Inventory Management across India.",
    url: "https://aexagency.com/in/services/ecommerce",
  },
};

export default function INEcommerceServicePage() {
