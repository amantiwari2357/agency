...
export const metadata: Metadata = {
  title: "Digital Marketing Solutions | AEX Agency India",
  description: "Digital Marketing & WhatsApp Business Integration across India. Pricing in INR.",
  alternates: {
    canonical: "https://aexagency.com/in/services/marketing",
  },
  openGraph: {
    title: "Digital Marketing Solutions | AEX Agency India",
    description: "Digital Marketing & WhatsApp Business Integration across India.",
    url: "https://aexagency.com/in/services/marketing",
  },
};

export default function INMarketingServicePage() {
