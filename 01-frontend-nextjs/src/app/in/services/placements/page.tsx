...
export const metadata: Metadata = {
  title: "HR Placements Solutions | AEX Agency India",
  description: "Campus Recruitment & HR Placements Portal across India. Pricing in INR.",
  alternates: {
    canonical: "https://aexagency.com/in/services/placements",
  },
  openGraph: {
    title: "HR Placements Solutions | AEX Agency India",
    description: "Campus Recruitment & HR Placements Portal across India.",
    url: "https://aexagency.com/in/services/placements",
  },
};

export default function INPlacementsServicePage() {
