...
export const metadata: Metadata = {
  title: "Real Estate Technology Solutions | AEX Agency United States",
  description: "Powering real estate brokerages and property developers across United States with high-speed IDX feeds, automated mortgage calculators, and WhatsApp agent booking integration. Pricing in USD.",
  alternates: {
    canonical: "https://aexagency.com/us/services/real-estate",
  },
  openGraph: {
    title: "Real Estate Technology Solutions | AEX Agency United States",
    description: "Powering real estate brokerages and property developers across United States with high-speed IDX feeds, automated mortgage calculators, and WhatsApp agent booking integration.",
    url: "https://aexagency.com/us/services/real-estate",
  },
};

export default function USRealEstateServicePage() {
