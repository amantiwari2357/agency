...
export const metadata: Metadata = {
  title: "Privacy Policy | AEX Agency United States",
  description: "Learn about AEX Agency's privacy policy and how we protect your data. Your privacy is important to us.",
  alternates: {
    canonical: "https://aexagency.com/us/privacy",
  },
  openGraph: {
    title: "Privacy Policy | AEX Agency United States",
    description: "Learn about AEX Agency's privacy policy and how we protect your data.",
    url: "https://aexagency.com/us/privacy",
  },
};
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none text-[#4a5060] space-y-6">
          ...
          <section>
            ...
            <p>Under CCPA and other applicable data protection laws, you have the right to access, correct, or delete your personal data. You may also object to or restrict processing of your data.</p>
          </section>
