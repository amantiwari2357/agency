...
export default function USCaseStudiesPage() {
  ...
  const caseStudies = [
    {
      title: "Luxury Properties New York",
      client: "Manhattan Estates",
    ...
    {
      title: "Fintech Startup Silicon Valley",
      client: "PayFlow US",
    ...
    {
      title: "Fashion Brand Los Angeles",
      client: "Boutique Style US",
    ...
    {
      title: "Engineering College Boston",
      client: "Tech University Boston",
