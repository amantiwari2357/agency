...
export default function USHelpCenterPage() {
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="tel:+16505550123" className="flex items-center gap-2 px-6 py-3 bg-white/20 text-white rounded-xl font-semibold hover:bg-white/30 transition-colors">
