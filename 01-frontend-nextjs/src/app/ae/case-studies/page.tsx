...
export default function AECaseStudiesPage() {
  ...
  const caseStudies = [
    ...
    {
      title: "Fintech Startup Abu Dhabi",
      client: "PayFlow UAE",
    ...
    {
      title: "Fashion Brand Dubai",
      client: "Boutique Style UAE",
    ...
    {
      title: "Engineering College Sharjah",
      client: "Tech University Sharjah",
