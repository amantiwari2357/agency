...
export const metadata: Metadata = {
  title: "HR Placements Solutions | AEX Agency United Arab Emirates",
  description: "Campus Recruitment & HR Placements Portal across United Arab Emirates. Pricing in AED.",
  alternates: {
    canonical: "https://aexagency.com/ae/services/placements",
  },
  openGraph: {
    title: "HR Placements Solutions | AEX Agency United Arab Emirates",
    description: "Campus Recruitment & HR Placements Portal across United Arab Emirates.",
    url: "https://aexagency.com/ae/services/placements",
  },
};

export default function AEPlacementsServicePage() {
