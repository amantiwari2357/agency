...
export const metadata: Metadata = {
  title: "SEO Services Solutions | AEX Agency United Arab Emirates",
  description: "Technical SEO & Schema Markup Generation across United Arab Emirates. Pricing in AED.",
  alternates: {
    canonical: "https://aexagency.com/ae/services/seo",
  },
  openGraph: {
    title: "SEO Services Solutions | AEX Agency United Arab Emirates",
    description: "Technical SEO & Schema Markup Generation across United Arab Emirates.",
    url: "https://aexagency.com/ae/services/seo",
  },
};
