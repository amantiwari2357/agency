...
export const metadata: Metadata = {
  title: "Privacy Policy | AEX Agency United Arab Emirates",
  description: "Learn about AEX Agency's privacy. Your rights and responsibilities.",
  alternates: {
    canonical: "https://aexagency.com/ae/privacy",
  },
  openGraph: {
    title: "Privacy Policy | AEX Agency United Arab Emirates",
    description: "Learn about AEX Agency's privacy.",
    url: "https://aexagency.com/ae/privacy",
  },
};
...
export default function AEPrivacyPage() {
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none text-[#4a5060] space-y-6">
          ...
          <section>
            ...
            <p>Under UAE data protection laws and other applicable regulations, you have the right to access, correct, or delete your personal data. You may also object to or restrict processing of your data.</p>
          </section>
