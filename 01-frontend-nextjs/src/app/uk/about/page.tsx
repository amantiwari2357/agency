      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-xl text-[#4a5060] max-w-3xl mx-auto leading-relaxed">
            We're a global technology agency delivering innovative digital solutions that transform businesses and drive growth across the United Kingdom and beyond.
          </p>
        </motion.div>
