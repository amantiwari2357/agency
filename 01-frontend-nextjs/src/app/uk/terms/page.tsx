...
export const metadata: Metadata = {
  title: "Terms of Service | AEX Agency United Kingdom",
  description: "Learn about AEX Agency's terms. Your rights and responsibilities.",
  alternates: {
    canonical: "https://aexagency.com/uk/terms",
  },
  openGraph: {
    title: "Terms of Service | AEX Agency United Kingdom",
    description: "Learn about AEX Agency's terms.",
    url: "https://aexagency.com/uk/terms",
  },
};
...
export default function UKTermsPage() {
  ...
  return (
    <>
      <SchemaMarkup countryCode={countryCode} pageType="terms" />
