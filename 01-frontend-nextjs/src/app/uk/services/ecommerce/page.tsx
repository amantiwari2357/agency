...
export const metadata: Metadata = {
  title: "E-Commerce Solutions | AEX Agency United Kingdom",
  description: "Fashion Retail Platforms & Inventory Management across United Kingdom. Pricing in GBP.",
  alternates: {
    canonical: "https://aexagency.com/uk/services/ecommerce",
  },
  openGraph: {
    title: "E-Commerce Solutions | AEX Agency United Kingdom",
    description: "Fashion Retail Platforms & Inventory Management across United Kingdom.",
    url: "https://aexagency.com/uk/services/ecommerce",
  },
};
