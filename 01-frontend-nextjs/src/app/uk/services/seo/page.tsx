...
export const metadata: Metadata = {
  title: "SEO Services Solutions | AEX Agency United Kingdom",
  description: "Technical SEO & Schema Markup Generation across United Kingdom. Pricing in GBP.",
  alternates: {
    canonical: "https://aexagency.com/uk/services/seo",
  },
  openGraph: {
    title: "SEO Services Solutions | AEX Agency United Kingdom",
    description: "Technical SEO & Schema Markup Generation across United Kingdom.",
    url: "https://aexagency.com/uk/services/seo",
  },
};

export default function UKSeoServicePage() {
