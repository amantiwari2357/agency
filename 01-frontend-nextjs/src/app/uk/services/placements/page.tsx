...
export const metadata: Metadata = {
  title: "HR Placements Solutions | AEX Agency United Kingdom",
  description: "Campus Recruitment & HR Placements Portal across United Kingdom. Pricing in GBP.",
  alternates: {
    canonical: "https://aexagency.com/uk/services/placements",
  },
  openGraph: {
    title: "HR Placements Solutions | AEX Agency United Kingdom",
    description: "Campus Recruitment & HR Placements Portal across United Kingdom.",
    url: "https://aexagency.com/uk/services/placements",
  },
};
