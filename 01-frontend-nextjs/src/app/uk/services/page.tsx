...
export default function UKServicesPage() {
  ...
  return (
    <>
      <SchemaMarkup countryCode={countryCode} pageType="services" />
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-xl text-[#4a5060] max-w-3xl mx-auto leading-relaxed">
            Comprehensive digital solutions designed to transform your business and drive sustainable growth across the United Kingdom.
          </p>
        </motion.div>
